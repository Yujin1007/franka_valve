...
namespace CustomMath
{
    ...
    static Eigen::Matrix3d GetBodyRotationMatrix(double Roll, double Pitch, double Yaw)
    {
        ...
        //return RGyro_inv;
        // std::cout<<"Rotation"<<RGyro<<std::endl;
        return RGyro;
    }
    ...
    */
    ...
    // rotations
    static Vector3d rotation6d2euler(const VectorXd R6){
        Matrix3d R;
        Vector3d a1;
        Vector3d a2;
        Vector3d a3;
        ...
        a1 << R6(0), R6(1), R6(2);
        a2 << R6(3), R6(4), R6(5);
        a1 = a1 / sqrt(pow(a1(0),2)+pow(a1(1),2)+pow(a1(2),2));
        a2 = a2 / sqrt(pow(a2(0),2)+pow(a2(1),2)+pow(a2(2),2));
        ...
        return GetBodyRotationAngle(R);
        
    }
    static Matrix3d rotation6d2rotation(const VectorXd R6){
        Matrix3d R;
        Vector3d a1;
        Vector3d a2;
        Vector3d a3;
