...
class JointSpaceImpedanceController : public controller_interface::MultiInterfaceController<
                                      franka_hw::FrankaModelInterface,
                                      hardware_interface::EffortJointInterface,
                                      franka_hw::FrankaStateInterface> {
 public:
  // JointSpaceImpedanceController();
  // virtual ~JointSpaceImpedanceController();
...
zmq::message_t reply;
 ...
 private:
  ...
  void InitMotionPlan(double init_theta, double goal_theta);
  ...
  void writeToCSVfile(string filename, MatrixXd qd, MatrixXd q, MatrixXd xd, MatrixXd x, MatrixXd xe, MatrixXd xdot2);
  ...
  VectorXd _x_hand, _xdot_hand, _x_des_hand, _xdot_des_hand, _x_err_hand, _xdot_err_hand;
  ...
  bool zmq_start;
  int zmq_cnt;
  MatrixXd _q_plot, _qdes_plot, _x_plot, _xdes_plot,_xdoterr_plot,_xerr_plot;
  int _cnt_plot;
};
