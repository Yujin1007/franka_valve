...
class RLController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  // void writeToCSVfile_step(string filename, MatrixXd obs, MatrixXd act);
  ...
  VectorXd _q_normalize_max, _q_normalize_min, _q_normalize;
