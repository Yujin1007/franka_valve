...
void VisionController::InitMotionPlan(double init_theta, double goal_theta) {
  ...
  _target_plan.x = _x_hand(0) + 0.1
  _target_plan.y = _x_hand(1) + 0.1
  _target_plan.z = _x_hand(2) + 0.1
  _target_plan.roll = _x_hand(3) + 0.1
  _target_plan.pitch = _x_hand(4) + 0.1
  _target_plan.yaw = _x_hand(5) + 0.1
